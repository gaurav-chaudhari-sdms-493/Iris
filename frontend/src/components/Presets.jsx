  ...
  return (
    <div className="iris-card">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <h2 className="text-sm font-bold text-slate-100">Smart Automation Presets</h2>
          <p className="text-xs text-slate-400 font-mono">One-Tap System Mode Controls</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
        ...
        <button
          ...
          className={`p-3.5 rounded-xl border text-left transition flex flex-col justify-between cursor-pointer ${
            currentMode === 'PRESENTATION'
              ? 'bg-purple-950/40 border-purple-500 text-slate-100 shadow-sm'
        ...
        >
          ...
          <div className="mt-2.5">
            <h3 className="font-bold text-xs text-slate-100">Presentation Preset</h3>
            <p className="text-xs text-slate-400 mt-0.5">Dims lights, sets AC to 24°C Quiet, turns TV ON.</p>
          </div>
        </button>
        ...
        <button
          ...
          className={`p-3.5 rounded-xl border text-left transition flex flex-col justify-between cursor-pointer ${
            currentMode === 'AUTO'
              ? 'bg-cyan-950/40 border-cyan-500 text-slate-100 shadow-sm'
              : 'bg-slate-900/60 hover:bg-slate-800/80 border-slate-800/80 text-slate-300'
          }`}
        >
          <div className="flex justify-between items-start">
        ...
        <button
          ...
          className={`p-3.5 rounded-xl border text-left transition flex flex-col justify-between cursor-pointer ${
            currentMode === 'POWER_SAVING'
              ? 'bg-amber-950/40 border-amber-500 text-slate-100 shadow-sm'
              : 'bg-slate-900/60 hover:bg-slate-800/80 border-slate-800/80 text-slate-300'
          }`}
        >
          <div className="flex justify-between items-start">
          ...
          <div className="mt-2.5">
            <h3 className="font-bold text-xs text-slate-100">Power Saving Vacate</h3>
            <p className="text-xs text-slate-400 mt-0.5">Immediate energy shutdown across all relays and AC.</p>
          </div>
        </button>
